        ...
        private void Form1_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            if (radioButton_node.Checked)
            {
                ...
                else if (radioButton_align.Checked)
                {
                    ...
                    {
                        if (alignMode == AlignMode.vertical) mesh.points[index] = new PointF(mesh.points[baseNode].X, mesh.points[index].Y);
                        else if (alignMode == AlignMode.horizontal) mesh.points[index] = new PointF(mesh.points[index].X, mesh.points[baseNode].Y);
                    }
                }
            }
